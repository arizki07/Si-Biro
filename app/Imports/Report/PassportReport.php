...
class PassportReport implements ToModel, WithHeadingRow
{
    /**
     * @param array $row
     *
    ...
    public function model(array $row)
    {
        ...
        $jadwal = JadwalModel::where('id_layanan', $id_layanan)->where('tipe_jadwal', 'PASSPORT')->first();
        if (!$jadwal) {

...
class ExportKeuangan implements FromCollection, WithHeadings, WithStyles
{
    public function __construct($periode_k)
    {
        $this->periode_keuangan = $periode_k;
    }
    ...
    public function collection()
    {
        $data = DB::table('t_keuangan as a')
            ...
            ->where('a.periode', $this->periode_keuangan)
    ...
    {
        $sheet->setTitle('KEUANGAN PERIODE ' . $this->periode_keuangan);

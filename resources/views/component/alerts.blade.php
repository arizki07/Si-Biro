<script>
    document.getElementById("sa-basic") && document.getElementById("sa-basic").addEventListener("click", function() {
            ...
            }), document.getElementById("sa-longcontent") && document.getElementById("sa-longcontent").addEventListener(
            "click",
            function() {
                Swal.fire({
            ...
            }), document.getElementById("custom-html-alert") && document.getElementById("custom-html-alert")
        ...
        }), document.getElementById("sa-dialog-three-btn") && document.getElementById("sa-dialog-three-btn")
        .addEventListener("click", function() {
            Swal.fire({
            ...
            }), document.getElementById("custom-padding-width-alert") && document.getElementById(
            "custom-padding-width-alert").addEventListener("click", function() {
            Swal.fire({
            ...
            }), document.getElementById("custom-sa-success") && document.getElementById("custom-sa-success")
        .addEventListener("click", function() {
            Swal.fire({
        ...
        }), document.getElementById("custom-sa-error") && document.getElementById("custom-sa-error").addEventListener(
            "click",
            function() {
                Swal.fire({
            ...
            }), document.getElementById("custom-sa-warning") && document.getElementById("custom-sa-warning")
        .addEventListener("click", function() {
            Swal.fire({
        ...
        }), document.getElementById("custom-sa-community") && document.getElementById("custom-sa-community")
        .addEventListener("click", function() {
            Swal.fire({
        ...
        }), document.getElementById("custom-sa-email-verify") && document.getElementById("custom-sa-email-verify")
        .addEventListener("click", function() {
            Swal.fire({
        ...
        }), document.getElementById("custom-sa-notification") && document.getElementById("custom-sa-notification")
        .addEventListener("click", function() {
            Swal.fire({

                        ...
                        <form enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="lastName" placeholder="Enter Kuota"
                                            name="kuota" value="{{ old('kuota', $item->kuota) }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xxl-6">
                                    ...
                                    <input type="text" class="form-control" id="passwordInput" placeholder="Enter Paket"
                                        name="paket" value="{{ old('paket', $item->paket) }}" readonly>
                                </div>
                                <!--end col-->
                                <!--end col-->
                                <div class="col-xxl-6">

...
@section('content')
    ...
    @foreach ($data as $trans)
        <div class="modal fade" id="editModal{{ $trans->id_transaksi }}" tabindex="-1" aria-labelledby="editModalLabel">
    ...
    @foreach ($data as $item)
        <div class="modal modal-blur fade" id="detailTrans{{ $item->id_transaksi }}" tabindex="-1" role="dialog"
            aria-hidden="true">
    ...
    @foreach ($data as $item)
        <div class="modal modal-blur fade" id="detailTransall{{ $item->id_transaksi }}" tabindex="-1" role="dialog"
            aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">

@extends('layout.authentication.mainAuth')
@section('contentAuth')
    <!-- auth-page wrapper -->
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            ...
                                            <iframe
                                                src="https://lottie.host/embed/610c7eea-c632-419b-b4da-d4c68dbde373/TMgeLKVlTI.json"
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Please register to Wadi Fatimah.</p>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                ...
                                </script> KBIH WADI FATIMAH <i class="mdi mdi-heart text-danger"></i>
                                by <a href="https://webcrafser.com/" class="text-white" target="_blank">Web
                                    Crafser</a>
                            </p>
                        </div>
                    </div>

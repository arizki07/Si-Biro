                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">OTP Register !</h5>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('otpVerification') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="otp_register" class="form-label">Kode OTP</label>
                                            <input type="number" class="form-control" id="otp_register"
                                                name="otp_register" aria-describedby="textHelp">
                                        </div>
                                        <button type="submit"

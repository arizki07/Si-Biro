                        ...
                        <div class="modal-body bg-marketplace d-flex">
                            <div class="row g-3">
                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <a type="button" href="/data-jadwal-office/delete/{{ $jad['id_jadwal'] }}" class="btn btn-danger">Hapus</a>
                                </div>
                                <!--end col-->
                            </div>
                        </div>
                        ...
                        <div class="modal-body bg-marketplace d-flex">
                            <div class="row g-3">
                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light"
                                    data-bs-dismiss="modal">Close</button>
                                    <a type="button" href="/data-uraian-jadwal-office/delete/{{ $urj['id_uraian_jadwal'] }}" class="btn btn-danger">Hapus</a>
                                </div>
                                <!--end col-->
                            </div>
                        </div>

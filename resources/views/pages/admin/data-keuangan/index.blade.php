...
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel"><i class=" ri-book-mark-fill"></i> Add Keuangan</h5>
                    ...
                    <form action="javascript:void(0);">
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-6">
                                ...
                                <input type="pembayaran" name="pembayaran" class="form-control" id="pembayaran"
                                    placeholder="Enter your email">
                            </div>
                            <!--end col-->
                            <div class="col-xxl-6">
                                <label for="passwordInput" class="form-label">keuangan</label>
                                <input type="text" class="form-control" id="tipe_keuangan" name="tipe_keuangan"
    ...
    {{-- Modal Import Excel --}}
    <div class="modal modal-blur fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">

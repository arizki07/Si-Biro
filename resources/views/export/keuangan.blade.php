    ...
    <div class="rangkasurat">
        <div class="header">
            <table width="100%">
                <tr>
                    <td>
                        <img src="https://tse1.mm.bing.net/th?id=OIP.PYfSkSnPpuMqZAHu-T_emQAAAA&pid=Api&P=0&w=300&h=300"
                            class="logo" alt="Logo">
                    </td>
                    <td class="td-atas">
                        <div class="tebal" style="font-size: 22px;">KBIH WADI FATIMAH</div>
                        ...
                        <div class="kontak">
                            E-mail: <font style="color: blue;">wadifatimah@gmail.com</font> Telp: (021) xxxxxx Website:
                            <font style="color: blue;">wadifatimah.com</font>
                        </div>
                    </td>
                    <td>
                        <img src="https://bapenda.jabarprov.go.id/wp-content/uploads/2017/05/Logo-propinsi-jawa-barat.png"
                            class="logo" alt="Logo">
                    </td>
                </tr>
            </table>
        ...
        <div class="header-content">
            <h3>Data Rekap Keuangan Priode 2024</h3>
        </div>
            ...
            <table class="table-bawah" style="margin-top: 10px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-bawah-second" align="center"><?= date('d-m-Y', strtotime($row['tgl_prestasi'])) ?>
                        </td>
        ...
        <div class="additional-info">
            ...
            <br><br><br><br><br><br>
            <strong style="text-decoration: underline;">Nama Kepala Sekolah</strong><br>

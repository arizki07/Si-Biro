                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted">A non-fungible token is a non-interchangeable unit of data stored on
                                a blockchain, a form of digital ledger, that can be sold and traded.</p>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Creative
                                        Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">The
                                        Chirstoper</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Evolved
                                        Reality</a></h5>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Abstract
                                        Face Painting</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Long-tailed
                                        Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="apps-nft-item-details.html" class="link-dark">Robotic
                                        Body Art</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Crypto Card
                                                    <span class="badge badge-soft-success">743</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="#!" class="float-end"> View All <i
                                                    class="ri-arrow-right-line align-bottom"></i></a>
                                            <h5 class="mb-0 fs-16"><a href="#!" class="link-dark">Photography
                                                    <span class="badge badge-soft-success">1452</span></a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
